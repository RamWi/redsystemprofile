...
function CEOMessage(){
    return(
        <>
            <section className="bg-[#0B141A] text-gray-200 w-full py-20 px-6 md:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
                {/* Teks Kiri */}
                <div className="md:w-2/3 space-y-6 text-justify">
                    ...
                    {/* Identitas CEO */}
                    <div className="mt-8">
                        <h4 className="text-white text-lg md:text-xl font-semibold">Kadek Bondan Noviadi</h4>
                ...
                <div className="md:w-1/3 flex justify-center">
                    ...
                    className="rounded-3xl shadow-[0_0_25px_rgba(255,0,0,0.25)] w-72 md:w-96 object-cover bg-white p-1"
                    />
                </div>
            </section>
        </>
